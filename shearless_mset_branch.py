...
def onclick(event):#右クリック二回で取得
    ...
    if  event.button == 1 and stat == 1:
        stat = 2
        print(stat)
        #plt.title('State2(Right Double click will be "decide")')
...
def Release():#Get x1,y1(initialoriginx,initialoriginy) Iはpです
    ...
    with open('orbit_a{}_b{}_{}_{}.txt'.format(a_str,b_str,step,number),'w') as o_hand:
