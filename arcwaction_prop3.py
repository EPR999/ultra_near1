...
def getsection_on_thetaplane(xi,eta,x1,x2,y1,y2):
	...
	#plt.show()
	fig  = plt.figure(figsize =  (14.402,8.388))
	#fig  = plt.figure(figsize =  (1383/72 ,752/72 ))
...
def drawingpoint(point,periodicpoint,period,ax):
	...
	for i in range(300):
		...
		if np.all(linepoints[2] > 0) == False:
			boolean_minusz = linepoints[2] > -0.00
			boolean_plusz = linepoints[2] < -0.00
			if np.all( np.abs(linepoints[2]) < 0.003 )  == False:
				...
				ax.plot(linepoints[0,boolean_minusz],linepoints[1,boolean_minusz],linepoints[2,boolean_minusz],'-',zorder = 100 - period,color = "blue",markersize = 12, lw = 5 )
				ax.plot(linepoints[0, boolean_plusz],linepoints[1,boolean_plusz],linepoints[2,boolean_plusz],'-',zorder = 100 - period,color = "blue" ,markersize = 12, lw = 5,linestyle = "dashed")
			else:
				...
				ax.plot(linepoints[0,boolean_minusz],linepoints[1,boolean_minusz],linepoints[2,boolean_minusz],'-',zorder = 100 - period,color = "blue",markersize = 12, lw = 5,alpha = 0.3 )
				ax.plot(linepoints[0, boolean_plusz],linepoints[1,boolean_plusz],linepoints[2,boolean_plusz],'-',zorder = 100 - period,color =  "blue",markersize = 12, lw = 5,linestyle = "dashed",alpha = 0.3)
		else :
			if np.all( np.abs(linepoints[2]) < 0.003 )  == False:
				#ax.plot(linepoints[0],linepoints[1],linepoints[2],'-',zorder = 100 - period,color = colormap(period - 3),markersize = 12, lw = 5 )
				ax.plot(linepoints[0],linepoints[1],linepoints[2],'-',zorder = 100 - period,color = "blue",markersize = 12, lw = 5 )
			else:
				ax.plot(linepoints[0],linepoints[1],linepoints[2],'-',zorder = 100 - period,color = "blue",markersize = 12, lw = 5 ,alpha = 0.3)
		print(point)
	...
	ax.plot(initpoint[0],initpoint[1],initpoint[2],'o',zorder = 100 - period,color = "blue",markersize = 12, lw = 5 )
