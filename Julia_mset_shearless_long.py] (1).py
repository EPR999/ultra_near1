...
def action2(x_cross):
    ...
    ax4.set_ylabel("Im(S)",fontsize = 27)
    ax4.set_xlabel("Time step",fontsize = 27)
    ...
    ax4.plot(iterates,actions,"-o",color ="red") 
    ...
    ax4.plot(iterates[boolean],actions[boolean],"o",markersize = 10,color = "green")
    iterates_str = np.array(np.asarray(iterates[boolean],dtype = int),dtype = str)
    print(iterates)
    ...
    for i in range(len(iterates_str)):
        ...
        ax4.text(iterates_bool[i]+0.1,actions_bool[i] + 0.1,iterates_str[i],fontsize = 15)
    #print(near_real[:,0])
